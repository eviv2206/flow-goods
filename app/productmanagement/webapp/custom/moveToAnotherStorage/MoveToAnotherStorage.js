...
sap.ui.define([
    ...
    "com/yauheni/sapryn/productmanagement/ext/util/ValidateForm",
], (JSONModel, ValidateForm) =>
    class {
        ...
        constructor(oView) {
            ...
            this.getBaseController = () => this.getController().getExtensionAPI().extension.com.yauheni.sapryn.productmanagement.ext.controller.ObjectPageExt;
        ...
        async onMoveToAnotherStorage(oBindingContext, aSelectedBindingContexts) {
            ...
            if (!this.oDialog) {
				this.oDialog = await this.getController().getExtensionAPI().loadFragment({
					...
					name: "com.yauheni.sapryn.productmanagement.custom.moveToAnotherStorage.MoveToAnotherStorageDialog",
					controller: this,
				});
        ...
        async onMoveButtonPress() {
            ...
            const oAction = this.getBaseController().getModel().bindContext("/ProductStorageMap(" + this.oData.ID + ")/ProductsService.moveToAnotherStorage(...)");
